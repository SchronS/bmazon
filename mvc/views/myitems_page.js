var myitemsView = function (model) {
    this.model = model;
...
myitemsView.prototype.init = function () {
    this.cacheObjects();
    this.handlers();
    this.enable();
};

myitemsView.prototype.cacheObjects = function () {

    this.$items_container = $("#myitems");
    return this;
};

myitemsView.prototype.addItem = function () {
    $.ajax({
        url: '/getRole',
        type: 'POST',
        dataType: 'json',
...
myitemsView.prototype.load = function () {
    this.loadEvent.notify();
}

myitemsView.prototype.loaded = function (data) {
    this.show(data);
}

myitemsView.prototype.handlers = function () {
    this.loadHandler = this.load.bind(this);
    this.loadedHandler = this.loaded.bind(this);
    this.addItemHandler = this.addItem.bind(this);
}

myitemsView.prototype.enable = function () {
...
myitemsView.prototype.show = function (data) {
